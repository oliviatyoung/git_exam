...
#make the first thing on the command line (after file name) the string of letters and the second teh substring length
__name__ == "__main__"
string = sys.argv[1]
k = int(sys.argv[2])
...
ling_comp = number_substrings/pos_substrings
def linguistic_complexity(string,k):
    ...
    '''
    ling_comp = float(number_substrings)/float(pos_substrings)
